...
// Variables for inserting SVGs as innerHTML
...
// Randomly get computer choice from choices list for comparing with user choice
...
// Selected nodes of rock, paper, and scissors button
const userChoice = document.querySelector('.user-choice');
const choices = userChoice.querySelectorAll('button');

// When one of the choices are clicked, call playRound() function to play a round
